...
const Login = () => {
    ...
    return (
        <div className='max-w-[1200px] px-5 mx-auto py-28 flex flex-col justify-center items-center'>
            <title>Login Page</title>
            <h2 className='text-4xl font-bold text-center mb-8'>Log In Your Account</h2>
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                <div className="card-body">
                    ...
                    <p className='mt-5'>Don't Have An Account? <Link className='text-secondary mt-4' to='/register'>Register</Link>  </p>
