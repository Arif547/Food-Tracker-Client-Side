...
import { Heart, MapPin, Users, Clock, ExternalLink, Phone, Mail } from 'lucide-react';
...
const DonateSection = () => (
    <div className="bg-gradient-to-br from-orange-50 via-yellow-50 to-amber-50 py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="text-center mb-16">
                ...
                <h2 className="text-5xl font-bold text-gray-800 mb-6">
                    Share the <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-yellow-600">Love</span>
                </h2>
                <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
                    Transform your surplus food into hope for others. Every donation helps fight hunger in your community
                    while reducing food waste – it's a win-win for everyone.
                </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
                ...
                <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
                    <div className="relative bg-white rounded-3xl p-4 shadow-2xl">
                        <img
                            ...
                            alt="People volunteering at food bank, sorting donations and helping community members"
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-gradient-to-r from-orange-100 to-yellow-100 rounded-2xl p-6 border border-orange-200">
                        <h4 className="text-lg font-semibold text-gray-800 mb-4">💡 Donation Guidelines</h4>
                ...
                <div className="bg-gradient-to-r from-orange-500 to-yellow-500 rounded-3xl p-12 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button className="bg-white text-orange-600 px-8 py-4 rounded-xl font-semibold hover:bg-orange-50 transition-colors duration-300 shadow-lg">
                                Find Donation Centers
                            </button>
                            <button className="bg-orange-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-orange-700 transition-colors duration-300 border-2 border-orange-400">
                                Learn More
                            </button>
                        </div>
                    </div>
